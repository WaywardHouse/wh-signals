...
The mechanism is not primarily layoffs. Permanent layoff rates have fallen roughly **10%** since October 2025 and remain in line with pre-pandemic averages. What is contracting is hiring intent: net staffing intentions turned negative in April for the first time this year, with **16%** of employers planning reductions against **14%** planning additions.[^13] Companies are managing attrition without replacing it — pausing backfills, deferring headcount, not announcing cuts. This is what structural contraction looks like before it becomes visible in monthly surveys: departures that go unreplaced rather than roles that get eliminated.
